...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(df[(df['salary'] == '>50K') & ((df['education'] == 'Bachelors') | (df['education'] == 'Masters') | (df['education'] == 'Doctorate'))].shape[0] / higher_education * 100, 1)
    lower_education_rich = round(df[(df['salary'] == '>50K') & ~((df['education'] == 'Bachelors') | (df['education'] == 'Masters') | (df['education'] == 'Doctorate'))].shape[0] / lower_education * 100, 1)
